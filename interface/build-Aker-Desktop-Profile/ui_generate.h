...
public:
    ...
    void setupUi(QMainWindow *generate)
    {
        ...
        verticalLayoutWidget->setGeometry(QRect(20, 110, 241, 431));
...
"border-bottom-color: rgb(0, 0, 0);"));
        ...
        verticalLayoutWidget_3->setGeometry(QRect(20, 20, 241, 81));
...
"border-bottom-color: rgb(0, 0, 0);"));
        ...
        verticalLayoutWidget_4->setGeometry(QRect(550, 20, 241, 471));
