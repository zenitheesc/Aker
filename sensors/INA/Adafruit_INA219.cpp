...
void Adafruit_INA219::wireWriteRegister (uint8_t reg, uint16_t value)
{
	HAL_StatusTypeDef status = 0;
		...
		status = HAL_I2C_Master_Transmit(&_hi2c1, ina219_i2caddr<<1, buffer, 3, 100);
}
...
void Adafruit_INA219::wireReadRegister(uint8_t reg, uint16_t *value)
{
	...
	status = HAL_I2C_Master_Transmit(&_hi2c1, ina219_i2caddr<<1, &reg, 1, 100);
	HAL_Delay(1); // Max 12-bit conversion time is 586us per sample

	uint8_t buffer[2] = {0,0};
	status = HAL_I2C_Master_Receive(&_hi2c1, ina219_i2caddr<<1, buffer, 2, 100);
...
*/
/**************************************************************************/
void Adafruit_INA219::begin(I2C_HandleTypeDef hi2c1) {
	ina219_currentDivider_mA = 0;
	ina219_powerMultiplier_mW = 0;
	_hi2c1 = hi2c1;
